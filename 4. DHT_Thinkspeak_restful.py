...
THINGSPEAK_WRITE_API_KEY = '3Q1PRJ3K8B221L32'
...
wlan.active(True)
wlan.connect('NokiaPlus','7985445332')
...
#         d.measure()
        #t = d.temperature()
        #h = d.humidity()
        Temp = random.randint(10, 50)  # Random temperature between 15 and 30 degrees Celsius
        humidity = random.randint(10, 100)
        # put data into json format
        dht_readings = {'field1':Temp,'field2':humidity}
